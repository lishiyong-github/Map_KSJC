...
- (void)buildScrollViewWithFrame:(CGRect)frame {
    ...
    self.scrollView.contentSize = CGSizeMake(contentXIndex, 768);
...
//    self.pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(0, self.frame.size.height - self.pageControlY, self.frame.size.width, 20)];
    self.pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(430, 670, 200, 20)];
...
//    UIView *kk=[[UIView alloc] initWithFrame:CGRectMake(410, 500, 200, 20)];
//    kk.backgroundColor=[UIColor redColor];
//    [self addSubview:kk];
...
//    UIView *bb=[[UIView alloc] initWithFrame:CGRectMake(0, 0, 1024, 768)];
...
- (void)setPageControlY:(CGFloat)pageControlY {
    ...
    //[self.pageControl setFrame:CGRectMake(280, 450, 200, 20)];
}
